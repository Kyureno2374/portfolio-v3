    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-6 py-24">
        ...
        >
          ...
          >
            <p className="text-base md:text-lg text-secondary dark:text-dark-secondary">
              <span className="font-semibold text-primary dark:text-dark-primary">4+</span> {language === "ru" ? "лет в разработке" : "years in dev"}
              <span className="mx-3 text-secondary/30 dark:text-dark-secondary/30">•</span>
              <span className="font-semibold text-primary dark:text-dark-primary">10+</span> {language === "ru" ? "проектов" : "projects"}
              <span className="mx-3 text-secondary/30 dark:text-dark-secondary/30">•</span>
              <span className="font-semibold text-primary dark:text-dark-primary">40+</span> {language === "ru" ? "технологий" : "technologies"}
            </p>
          </motion.div>
